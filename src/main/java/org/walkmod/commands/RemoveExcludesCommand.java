...
@Parameters(separators = "=", commandDescription = "Removes exclude rules from the configuration.")
public class RemoveExcludesCommand implements Command {
	...
	public RemoveExcludesCommand(JCommander jcommander) {
		this.jcommander = jcommander;
	}

	public RemoveExcludesCommand(List<String> excludes, String chain, boolean setToResder, boolean setToWriter,
			boolean recursive) {
		this.excludes = excludes;
		this.chain = chain;
		this.setToWriter = setToWriter;
		this.setToReader = setToResder;
