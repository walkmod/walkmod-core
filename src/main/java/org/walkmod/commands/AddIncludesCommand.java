...
@Parameters(separators = "=", commandDescription = "Adds includes rules to the configuration.")
public class AddIncludesCommand implements Command {

	@Parameter(description = "List of includes to add", required = true)
	...
	public AddIncludesCommand(JCommander jcommander) {
		this.jcommander = jcommander;
	}

	public AddIncludesCommand(List<String> includes, boolean recursive, boolean setToReader, boolean setToWriter) {
